...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "auth.welcome": "Welcome to NederLearn",
    "auth.subtitle": "Master Dutch vocabulary with fun quizzes",
    ...
    "auth.localStorageInfo": "Your progress is saved locally on this device",
  ...
  ar: {
    ...
    "settings.english": "English",
    "settings.arabic": "العربية",
    "auth.welcome": "مرحباً بك في NederLearn",
    "auth.subtitle": "تعلّم المفردات الهولندية بطريقة ممتعة",
    "auth.nameLabel": "اسمك",
    "auth.namePlaceholder": "أدخل اسمك",
    "auth.startLearning": "ابدأ التعلّم",
    "auth.loading": "جاري البدء...",
    "auth.error": "خطأ",
    "auth.nameRequired": "الرجاء إدخال اسمك",
    "auth.nameTooShort": "يجب أن يكون الاسم حرفين على الأقل",
    "auth.errorMessage": "حدث خطأ ما. الرجاء المحاولة مرة أخرى.",
    "auth.localStorageInfo": "يتم حفظ تقدمك محلياً على هذا الجهاز",
